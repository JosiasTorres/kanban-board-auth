...
import { fileURLToPath } from "url"; // 🔥 Solución para __dirname en ES Modules

import routes from "./routes/index.js"; // Asegúrate que esto coincide con moduleResolution
